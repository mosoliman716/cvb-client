...
const Login = () => {
  ...
  const [state, setState] = useState(userState || "login");
  ...
  return (
    ...
    <form
      ...
      id="login-form"
      className="sm:w-[350px] w-full text-center border border-gray-300/60 rounded-2xl px-8 bg-white flex flex-col items-center mt-50% mb-50% mr-auto ml-auto shadow-lg"
    >
