export default function Features() {
  return (
    <>
      <div className="flex justify-center flex-col items-center max-w-7xl m-5" id="features">
        <h1
          id="feature-head"
          className="text-3xl font-semibold text-center m-5"
        >
          CVB Features
        </h1>
        <p
          id="feature-desc"
          className="text-sm text-slate-500 text-center m-5 max-w-md "
        >
          Create, preview, and download your professional CV in minutes. Easy,
          fast, and customizable.
        </p>
        <div className="flex items-center justify-center flex-wrap gap-6 lg:mr-5 mb-5 px-4 md:px-0">
          <div className="flex flex-col text-center items-center justify-center rounded-xl p-15 border border-violet-200 gap-6 max-w-sm h-60 hover:bg-indigo-300">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-slate-600">
                See your CV update instantly as you edit your information.
              </p>
            </div>
          </div>
          <div className="flex flex-col text-center items-center justify-center rounded-xl p-6 border border-green-200 gap-6 max-w-sm h-60 hover:bg-indigo-300">
          ...
          <div className="flex flex-col text-center items-center justify-center rounded-xl p-6 border border-orange-200 gap-6 max-w-sm h-60 hover:bg-indigo-300">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-slate-600">
                Export your CV as PDF or Word for job applications.
              </p>
            </div>
          </div>
        </div>
